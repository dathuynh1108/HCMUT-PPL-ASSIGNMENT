...
class ASTGenSuite(unittest.TestCase):
    ...
    def test_015_logical_expression(self):
        ...
        """
        expect = """Program([ClassDecl(Id(Program),[AttributeDecl(Instance,VarDecl(Id(a),IntType,BinaryOp(&&,Id(a),BooleanLit(True)))),AttributeDecl(Instance,VarDecl(Id(b),IntType,BinaryOp(||,Id(b),BooleanLit(True))))])])"""
        num = 315
        self.assertTrue(TestAST.test(input, expect, num))
    ...
    def test_025_simple_mix_expression(self):
        ...
        """
        expect = "Program([ClassDecl(Id(Program),[MethodDecl(Id(main),Static,[],Block([VarDecl(Id(a),IntType),AssignStmt(Id(a),BinaryOp(||,BinaryOp(&&,BinaryOp(%,BinaryOp(/,BinaryOp(*,UnaryOp(!,BinaryOp(+,UnaryOp(-,IntLit(1)),IntLit(2))),IntLit(3)),IntLit(4)),IntLit(5)),BooleanLit(True)),BooleanLit(True))),AssignStmt(Id(a),BinaryOp(==,IntLit(1),IntLit(2))),AssignStmt(Id(a),BinaryOp(!=,IntLit(1),IntLit(2))),AssignStmt(Id(a),BinaryOp(>,IntLit(1),IntLit(2))),AssignStmt(Id(a),BinaryOp(<,IntLit(1),IntLit(2))),AssignStmt(Id(a),BinaryOp(>=,IntLit(1),IntLit(2))),AssignStmt(Id(a),BinaryOp(<=,IntLit(1),IntLit(2)))]))])])"
        num = 325
        self.assertTrue(TestAST.test(input, expect, num))
