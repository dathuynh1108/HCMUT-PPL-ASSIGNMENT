...
class ASTGenSuite(unittest.TestCase):
    ...
    def test_309_variable_declare_2(self):
        ...
        expect = """Program([ClassDecl(Id(Program),Id(Parent),[AttributeDecl(Instance,ConstDecl(Id(x),IntType,None)),AttributeDecl(Instance,ConstDecl(Id(y),FloatType,None)),AttributeDecl(Instance,ConstDecl(Id(x),StringType,None)),AttributeDecl(Instance,ConstDecl(Id(y),StringType,None)),AttributeDecl(Instance,ConstDecl(Id(m),BoolType,None)),AttributeDecl(Instance,ConstDecl(Id(n),BoolType,None)),AttributeDecl(Instance,ConstDecl(Id(p),BoolType,None)),AttributeDecl(Instance,ConstDecl(Id(a),ArrayType(5,IntType),None)),AttributeDecl(Instance,ConstDecl(Id(b),ArrayType(5,ArrayType(3,FloatType)),None)),AttributeDecl(Instance,ConstDecl(Id(c),FloatType,None)),AttributeDecl(Instance,ConstDecl(Id(x),ArrayType(342391,IntType),None)),AttributeDecl(Instance,ConstDecl(Id(y),ArrayType(342391,IntType),None)),AttributeDecl(Instance,ConstDecl(Id(z),ArrayType(342391,IntType),None))])])"""
    ...
    def test_347_variable_declare_5(self):
        ...
        expect = """Program([ClassDecl(Id(Program),[AttributeDecl(Instance,VarDecl(Id(x),IntType)),AttributeDecl(Instance,VarDecl(Id(y),IntType)),AttributeDecl(Static,VarDecl(Id($z),IntType)),AttributeDecl(Instance,ConstDecl(Id(a),FloatType,None)),AttributeDecl(Static,ConstDecl(Id($b),FloatType,None)),AttributeDecl(Instance,ConstDecl(Id(c),FloatType,None)),AttributeDecl(Instance,VarDecl(Id(m),StringType)),AttributeDecl(Instance,VarDecl(Id(n),StringType)),AttributeDecl(Instance,VarDecl(Id(p),StringType)),AttributeDecl(Static,VarDecl(Id($m),BoolType)),AttributeDecl(Static,VarDecl(Id($n),BoolType)),AttributeDecl(Static,VarDecl(Id($p),BoolType)),AttributeDecl(Static,ConstDecl(Id($i),FloatType,None)),AttributeDecl(Static,ConstDecl(Id($j),FloatType,None)),AttributeDecl(Static,ConstDecl(Id($k),FloatType,None)),MethodDecl(Id(main),Static,[],Block([VarDecl(Id(x),IntType),VarDecl(Id(y),IntType),VarDecl(Id(z),IntType),ConstDecl(Id(a),FloatType,None),ConstDecl(Id(b),FloatType,None),ConstDecl(Id(c),FloatType,None),VarDecl(Id(m),StringType),VarDecl(Id(n),StringType),VarDecl(Id(p),StringType),VarDecl(Id(m),BoolType),VarDecl(Id(n),BoolType),VarDecl(Id(p),BoolType),ConstDecl(Id(i),FloatType,None),ConstDecl(Id(j),FloatType,None),ConstDecl(Id(k),FloatType,None)])),MethodDecl(Id($main),Static,[],Block([])),MethodDecl(Id($method),Static,[],Block([])),MethodDecl(Id(method),Instance,[],Block([])),MethodDecl(Id($main),Static,[param(Id(a),IntType),param(Id(b),ClassType(Id(SomeClass))),param(Id(c),ArrayType(5,IntType)),param(Id(d),ArrayType(5,IntType)),param(Id(e),BoolType)],Block([])),MethodDecl(Id($method),Static,[param(Id(a),FloatType),param(Id(b),ClassType(Id(SomeClass))),param(Id(c),ArrayType(5,IntType)),param(Id(d),ArrayType(5,IntType)),param(Id(e),StringType)],Block([])),MethodDecl(Id(method),Instance,[param(Id(a),ArrayType(5,ArrayType(5,FloatType))),param(Id(b),ClassType(Id(SomeClass))),param(Id(c),ArrayType(5,IntType)),param(Id(d),ArrayType(5,IntType)),param(Id(e),BoolType)],Block([]))])])"""
    ...
    def test_391_class_type_declare_1(self):
        ...
        expect = """Program([ClassDecl(Id(Program),[AttributeDecl(Instance,VarDecl(Id(x),ClassType(Id(SomeClass)),NullLiteral())),AttributeDecl(Instance,ConstDecl(Id(y),ClassType(Id(SomeClass)),None)),AttributeDecl(Static,VarDecl(Id($a),ClassType(Id(SomeClass)),NullLiteral())),AttributeDecl(Static,ConstDecl(Id($y),ClassType(Id(SomeClass)),None)),MethodDecl(Id(main),Static,[],Block([]))])])"""
    ...
    def test_392_class_type_declare_2(self):
        ...
        expect = """Program([ClassDecl(Id(Program),[MethodDecl(Id(main),Static,[],Block([VarDecl(Id(x),ClassType(Id(SomeClass)),NullLiteral()),ConstDecl(Id(y),ClassType(Id(SomeClass)),None)]))])])"""
    ...
    def test_393_class_type_declare_3(self):
        ...
        expect = """Program([ClassDecl(Id(Program),[AttributeDecl(Instance,VarDecl(Id(a),ClassType(Id(SomeClass)),NullLiteral())),AttributeDecl(Instance,VarDecl(Id(b),ClassType(Id(SomeClass)),NullLiteral())),AttributeDecl(Instance,ConstDecl(Id(c),ClassType(Id(SomeClass)),None)),AttributeDecl(Static,ConstDecl(Id($d),ClassType(Id(SomeClass)),None)),AttributeDecl(Static,VarDecl(Id($e),ClassType(Id(SomeClass)),NewExpr(Id(X),[]))),AttributeDecl(Static,VarDecl(Id($f),ClassType(Id(SomeClass)),StringLit(Nhan))),MethodDecl(Id(main),Static,[],Block([]))])])"""
    ...
    def test_394_class_type_declare_4(self):
        ...
        expect = """Program([ClassDecl(Id(Program),[MethodDecl(Id(main),Static,[],Block([VarDecl(Id(a),ClassType(Id(SomeClass)),NullLiteral()),VarDecl(Id(b),ClassType(Id(SomeClass)),NullLiteral()),ConstDecl(Id(c),ClassType(Id(SomeClass)),None),ConstDecl(Id(d),ClassType(Id(SomeClass)),None),VarDecl(Id(e),ClassType(Id(SomeClass)),NewExpr(Id(X),[])),VarDecl(Id(f),ClassType(Id(SomeClass)),StringLit(Nhan))]))])])"""
