...
class D96Visitor(ParseTreeVisitor):
    ...
    def visitAttribute_initialization(
        self, ctx: D96Parser.Attribute_initializationContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by D96Parser#attribute_initialization_list.
    def visitAttribute_initialization_list(
        self, ctx: D96Parser.Attribute_initialization_listContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitConstructor_declaration(
        self, ctx: D96Parser.Constructor_declarationContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitMulti_demensional_array(
        self, ctx: D96Parser.Multi_demensional_arrayContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitInstance_access_expression(
        self, ctx: D96Parser.Instance_access_expressionContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by D96Parser#static_access_expression.
    def visitStatic_access_expression(
        self, ctx: D96Parser.Static_access_expressionContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by D96Parser#object_creation_expression.
    def visitObject_creation_expression(
        self, ctx: D96Parser.Object_creation_expressionContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitVariable_and_const_declaration(
        self, ctx: D96Parser.Variable_and_const_declarationContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by D96Parser#variable_initialization.
    def visitVariable_initialization(
        self, ctx: D96Parser.Variable_initializationContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by D96Parser#variable_initialization_list.
    def visitVariable_initialization_list(
        self, ctx: D96Parser.Variable_initialization_listContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitMethod_invocation_statement(
        self, ctx: D96Parser.Method_invocation_statementContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by D96Parser#instance_method_invocation.
    def visitInstance_method_invocation(
        self, ctx: D96Parser.Instance_method_invocationContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by D96Parser#prefix_instance_method_invocation.
    def visitPrefix_instance_method_invocation(
        self, ctx: D96Parser.Prefix_instance_method_invocationContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by D96Parser#static_method_invocation.
    def visitStatic_method_invocation(
        self, ctx: D96Parser.Static_method_invocationContext
    ):
        return self.visitChildren(ctx)
