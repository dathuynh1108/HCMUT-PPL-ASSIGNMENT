...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\u0213\7\67\2\2\u0213i\3\2\2\2\u0214\u0215\5l\67\2\u0215")
...
class D96Parser ( Parser ):
    ...
    def variable_and_const_declaration(self):
        ...
        try:
            ...
            self.state = 427
            self.match(D96Parser.ID)
            getInvokingContext(39).number_variable+=1
            self.state = 434
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while _la==D96Parser.COMMA:
    ...
    def variable_initialization_list(self):
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    self.state = 448
                    if not getInvokingContext(39).number_variable > 0:
                        from antlr4.error.Errors import FailedPredicateException
    ...
    def variable_initialization_list_sempred(self, localctx:Variable_initialization_listContext, predIndex:int):
            if predIndex == 8:
                return getInvokingContext(39).number_variable > 0
