...
class ParserSuite(unittest.TestCase):
    ...
    def test_077_direct_statement_in_class(self):
        input = """
            ...
            a = 1;
        """
        expect = r"""Error on line 38 col 12: a"""
        num = 277
        self.assertTrue(TestParser.test(input,expect,num))
    ...
    def test_079_self_access_and_null_literal(self):
        ...
        """
        expect = r"""Error on line 17 col 25: Self"""
        num = 279
        self.assertTrue(TestParser.test(input,expect,num))
    ...
    def test_085_index_and_access_expression(self):
        ...
        """
        expect = r"Error on line 12 col 28: ."
        num = 285
        self.assertTrue(TestParser.test(input,expect,num))
        ...
        input = r"""
            Class Program {
                main() {
                    a = True && "String";
                    a = "String" + 1 +. "String";
                    a = "String" || "String" && "String" * 0 / 0x0 % (a + $a + a.a + Class_name::$a);
                    a = 0 + 0x0 + 0X0 + 0b0 + 0B0;
                    ...
                    a = (1).b[1][1][1][1][1];
                    a = (a+b+c).a.a.a[1[1[1[1[1[1]]]]]][1][a.b][Class_name::$a][a][$a];
                    a = New X()[1];
                    a = New X().a;
    ...
    def test_088_invalid_method_inovation_statement(self):
        ...
        """
        expect = r"Error on line 9 col 22: $a"
        num = 288
        self.assertTrue(TestParser.test(input,expect,num))
    def test_089_invalid_method_inovation_statement(self):
        ...
        """
        expect = r"Error on line 9 col 23: a"
        num = 289
        self.assertTrue(TestParser.test(input,expect,num))
    ...
    def test_091_left_hand_size_form(self):
        input = r"""
            Class Program {
                main() {
                    a = New X();
                    a = "String" || "String" && "String" * 0 / 0x0 % (a + $a + a.a + Class_name::$a - a.a() - Class_name::$a());
                    a[1] = "String" || "String" && "String" * 0 / 0x0 % (a + $a + a.a + Class_name::$a- a.a() - Class_name::$a());
                    a[1][1][1] = "String" || "String" && "String" * 0 / 0x0 % (a + $a + a.a + Class_name::$a- a.a() - Class_name::$a());
                    a[a[a[a[1]]]][a[a[a]]] = "String" || "String" && "String" * 0 / 0x0 % (a + $a + a.a + Class_name::$a- a.a() - Class_name::$a());
                    a.a = "String" || "String" && "String" * 0 / 0x0 % (a + $a + a.a + Class_name::$a- a.a() - Class_name::$a());
                    a.a.a = "String" || "String" && "String" * 0 / 0x0 % (a + $a + a.a + Class_name::$a- a.a() - Class_name::$a());
                    A::$a = "String" || "String" && "String" * 0 / 0x0 % (a + $a + a.a + Class_name::$a- a.a() - Class_name::$a());
                    A::$a.a = "String" || "String" && "String" * 0 / 0x0 % (a + $a + a.a + Class_name::$a- a.a() - Class_name::$a());
                }
            }
    ...
    def test_092_destructor_with_param(self):
        ...
        num = 292
        self.assertTrue(TestParser.test(input,expect,num))
    def test_093_multi_destructor(self):
        ...
        num = 293
        self.assertTrue(TestParser.test(input,expect,num))
    def test_094_constructor_without_return(self):
        # Not valid but ok in parser
        input = """
            Class Program {
                Constructor() {}
    ...
    def test_098_declaration_invalid(self):
        ...
        num = 298
        self.assertTrue(TestParser.test(input,expect,num))
    def test_099_declaration_invalid_attribute(self):
        input = r"""
            Class Program {
                Var a,$b,$c: Int = 1,2,3; ## Equal ##
                Var a,$b,$c: Int = 1,2,3; ## Equal ##
                Var a,$b,$c: Int = 1,2; ## Less than ##
                main() {
                    Var a,b,c: Int = 1,2,3; ## Equal ##
                    Val a,b,c: Int = 1,2,3; ## Equal ##
                }
        ...
        """
        expect = r"Error on line 5 col 38: ;"
        num = 299
        self.assertTrue(TestParser.test(input,expect,num))
    def test_100_declaration_invalid_attribute(self):
        input = r"""
            Class Program {
                Var a,$b,$c: Int = 1,2,3; ## Equal ##
                Var a,$b,$c: Int = 1,2,3; ## Equal ##
                Var a,$b,$c: Int = 1,2,3,4; ## Greater than ##
                main() {
                    Var a,b,c: Int = 1,2,3; ## Equal ##
                    Val a,b,c: Int = 1,2,3; ## Equal ##
                }
        ...
        """
        expect = r"Error on line 5 col 40: ,"
        num = 300
        self.assertTrue(TestParser.test(input,expect,num))
