...
class LexerSuite(unittest.TestCase):
    ...
    def test_042_float(self):
        ...
        """
        expect = r"""123e123,123E123,123e-123,123E-123,00,123e00123,00,123E00123,<EOF>"""
        num = 142
        self.assertTrue(TestLexer.test(input,expect,num))  
    ...
    def test_mix_46(self):
        self.assertTrue(TestLexer.test("\"String with single quote \'this is good\'\"", "String with single quote 'this is good',<EOF>", 999))